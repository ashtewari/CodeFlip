...
namespace CodeFlip_IntegrationTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(AshTewari.CodeFlip.GuidList.guidCodeFlipCmdSet, (int)AshTewari.CodeFlip.PkgCmdIDList.cmdIdFlipCodeWithT4);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "CodeFlip", "AshTewari.CodeFlip.CodeFlipPackage");
