...
using AshTewari.CodeFlip;

namespace CodeFlip_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new CodeFlipPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(AshTewari.CodeFlip.GuidList.guidCodeFlipCmdSet, (int)AshTewari.CodeFlip.PkgCmdIDList.cmdIdFlipCodeWithT4);
