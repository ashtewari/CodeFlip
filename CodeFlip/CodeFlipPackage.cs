...
namespace AshTewari.CodeFlip
{
    ...
    [Guid(GuidList.guidCodeFlipPkgString)]
    public sealed class CodeFlipPackage : Package
    {
        ...
        protected override void Initialize()
        {
            ...
            if ( null != mcs )
            {
                ...
                CommandID menuCommandID = new CommandID(GuidList.guidCodeFlipCmdSet, (int)PkgCmdIDList.cmdIdFlipCodeWithT4);
        ...
        private void MenuItemCallback(object sender, EventArgs e)
        {
            try
            {
                new Transformer().Transform(dte);
            }
            catch (Exception exception)
            {
                MessageBox.Show(exception.Message, "CodeFlip Error", MessageBoxButtons.OK);
            }
        }
